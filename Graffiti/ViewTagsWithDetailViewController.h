...
@interface ViewTagsWithDetailViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate>


@property (strong, nonatomic) IBOutlet UIView *lblHeader;
@property (strong, nonatomic) IBOutlet UIImageView *imgContent;
@property (strong, nonatomic) IBOutlet UITextView *lblDetails;
